...
void Character::init() {
	sfall::HookCalls(CharacterWinAddHook, {
		0x4A7496, // select_init_
		0x432DE8  // CharEditStart_
	});

	sfall::HookCalls(CharacterInputWinAddHook, {
	...
	sfall::HookCall(0x41D104, dialog_out_hook_win_add);

	sfall::HookCalls(CharacterMouseGetPositionHook, {
