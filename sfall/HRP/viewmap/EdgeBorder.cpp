...
static struct Edge { // sizeof = 0x54
	...
	RECT rect_4;
	long field_48;
	Edge* nextEdgeData_4C; // unused? (use in 3.06)
...
static void CalcEdgeData(Edge* edgeData, long w, long h) {
	...
	// R2000, L1000 : 1000-2000 = -1000/2 = -500+2000 = 1500 нет ли здесь ошибки?
		...
		if (getValue == mapLevel) {
			while (true) {
				...
				if (getValue == mapLevel) {
					Edge *edge = new Edge;
					edge->nextEdgeData_50 = nullptr;
					edge->rect_4 = edgeData->rect_4; // копируем
