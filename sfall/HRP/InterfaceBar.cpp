...
static void GetAmmoMetreColors(long yPercent, unsigned char &outClr1, unsigned char &outClr2) {
...
void IFaceBar::init() {
	...
	if (ALTERNATE_AMMO_METRE) {
		...
		sf::HookCall(0x45F954, intface_update_ammo_lights_hook); // replacement intface_draw_ammo_lights_
	}
