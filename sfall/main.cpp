...
static void SfallInit() {
	...
	if (!overrideIni.empty()) {
		...
		if (h != INVALID_HANDLE_VALUE) {
			...
			MessageBoxA(0, "You gave a command line argument to Fallout, but this configuration file was not found.\n"
