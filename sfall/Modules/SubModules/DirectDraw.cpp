...
static long __stdcall DirectDrawInit(DWORD, IDirectDraw7* _ddObject, DWORD) {
	...
	// Create direct draw clipper for windowed mode
	if (Graphics::IsWindowedMode) {
...
void DirectDraw::init() {
	...
	// GNW95_init_mode_ex_
	SafeWrite32(0x4CAE72, (DWORD)&GNW95_ShowRect);     // replace engine GNW95_ShowRect_ to sfall function
	SafeWrite32(0x4CAE77, (DWORD)&GNW95_zero_vid_mem); // replace engine GNW95_zero_vid_mem_ to sfall function
