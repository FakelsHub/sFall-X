...
namespace AIpref {
	...
	enum class weapon_pref : long
	{
		...
		ranged                = 4,
		unarmed               = 5,
		unarmed_over_thrown   = 6, // not avaible for party member in control panel
		random                = 7  // not avaible for party member in control panel
	};

	enum class area_attack_mode : long
	{
		no_pref               = -1, // special logic for NPC (not avaible for party member in control panel)
		always                = 0,
