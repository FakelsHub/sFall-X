...
WRAP_WATCOM_FFUNC4(long, ai_find_attackers, GameObject*, source, GameObject**, outTarget1, GameObject**, outTarget2, GameObject**, outTarget3)
...
WRAP_WATCOM_FUNC1(GameObject*, combatAIInfoGetLastTarget, GameObject*, critter)
...
WRAP_WATCOM_FUNC2(long, item_w_area_damage_radius, GameObject*, item, AttackType, hitMode)
