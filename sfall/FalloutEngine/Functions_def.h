...
WRAP_WATCOM_FFUNC5(long, determine_to_hit_from_tile, fo::GameObject*, source, long, sourceTile, fo::GameObject*, target, long, bodyPart, long, hitMode)
WRAP_WATCOM_FFUNC4(long, determine_to_hit_no_range, fo::GameObject*, source, fo::GameObject*, target, long, bodyPart, long, hitMode)
...
WRAP_WATCOM_FUNC2(long, ai_run_away, fo::GameObject*, source, fo::GameObject*, target)
...
WRAP_WATCOM_FUNC1(long, cai_get_min_hp, fo::AIcap*, cap)
WRAP_WATCOM_FUNC2(long, cai_perform_distance_prefs, fo::GameObject*, source, fo::GameObject*, target)
WRAP_WATCOM_FUNC1(fo::GameObject*, combatAIInfoGetFriendlyDead, fo::GameObject*, critter)
WRAP_WATCOM_FUNC1(fo::GameObject*, combatAIInfoGetLastTarget, fo::GameObject*, critter)
WRAP_WATCOM_FUNC2(long, combatAIInfoSetFriendlyDead, fo::GameObject*, critter, fo::GameObject*, deadCritter)
WRAP_WATCOM_FUNC1(long, combatai_rating, fo::GameObject*, critter)
...
WRAP_WATCOM_FUNC2(long, item_w_area_damage_radius, fo::GameObject*, item, fo::AttackType, hitMode)
...
WRAP_WATCOM_FUNC2(long, item_w_can_reload, fo::GameObject*, weapon, fo::GameObject*, ammo)
...
WRAP_WATCOM_FUNC2(long, item_w_skill, fo::GameObject*, item, long, hitMode)
