...
// compared to the original implementation, this function gets the hexes (tile) from the constructed line more correctly
long __fastcall Tilemap::tile_num_beyond(long sourceTile, long targetTile, long maxRange) {
	...
	// TODO: come up with a better way, without having to shift the point
