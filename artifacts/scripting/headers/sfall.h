...
#define get_interface_x(winID)                          sfall_func2("get_window_attribute", winID, 1)
#define get_interface_y(winID)                          sfall_func2("get_window_attribute", winID, 2)
...
#define intface_is_show(winID)                          sfall_func1("get_window_attribute", winID)
